...
public abstract class GUI {
	...
	protected abstract void doArtPoints(); //REEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
	...
	private void initialise() {
		...
		JButton articulation = new JButton("Articulation Points");
		...
		controls.add(articulation); //I made this
		controls.add(Box.createRigidArea(new Dimension(15, 0)));
